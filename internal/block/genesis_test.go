...
func TestGetGenesisBlock(t *testing.T) {
	...
	assert.Equal(t, int64(1651403471), genesisblockValid.Timestamp)
	...
	fromBytes, err := hexutil.Decode(genesisblockValid.Transactions[0].From)
	assert.NoError(t, err)
	assert.Len(t, fromBytes, 20)
	assert.Len(t, "0xdd9a374e8dce9d656073ec153580301b7d2c3850", 42)
}
